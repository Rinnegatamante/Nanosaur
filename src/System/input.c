...
#ifdef __vita__
[kNeed_JetUp			] = {{SDL_SCANCODE_A,		0,						}, 0,					0,	{SDL_CONTROLLER_BUTTON_LEFTSHOULDER,SDL_CONTROLLER_BUTTON_INVALID,      }, SDL_CONTROLLER_AXIS_INVALID,	   0,		},
[kNeed_JetDown			] = {{SDL_SCANCODE_Z,		0,						}, 0,					0,	{SDL_CONTROLLER_BUTTON_RIGHTSHOULDER,SDL_CONTROLLER_BUTTON_INVALID,     }, SDL_CONTROLLER_AXIS_INVALID,     0,		},
//[kNeed_PrevWeapon		] = {{0,					0,						}, 0,					+1,	{SDL_CONTROLLER_BUTTON_LEFTSHOULDER,SDL_CONTROLLER_BUTTON_INVALID,		}, SDL_CONTROLLER_AXIS_INVALID,		0,		},
[kNeed_AttackMode		] = {{SDL_SCANCODE_LSHIFT,	SDL_SCANCODE_RSHIFT,	}, 0,					-1,	{SDL_CONTROLLER_BUTTON_Y, 			SDL_CONTROLLER_BUTTON_INVALID,      }, SDL_CONTROLLER_AXIS_INVALID,		0,		},
#else
...
#ifdef __vita__
[kNeed_CameraMode		] = {{SDL_SCANCODE_TAB,		0,						}, 0,					0,	{SDL_CONTROLLER_BUTTON_BACK,	    SDL_CONTROLLER_BUTTON_INVALID,		}, SDL_CONTROLLER_AXIS_INVALID,		0,		},
#else
...
#ifdef __vita__
[kNeed_ToggleGPS		] = {{SDL_SCANCODE_G,		0,						}, 0,					0,	{SDL_CONTROLLER_BUTTON_INVALID,		SDL_CONTROLLER_BUTTON_INVALID,		}, SDL_CONTROLLER_AXIS_INVALID,		0,		},
#else
